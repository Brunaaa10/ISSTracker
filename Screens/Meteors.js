...
import { View, TouchiableOpacity, TextInput, Text, StyleSheet, Alert, SafeAreaView, FlatList, Image, ImageBackground, StatusBar, Dimensions} from "react-native"
...
export default class Meteors extends React.Component {
    ...
    renderItem = ({ item }) => {
        ...
        speed = require("../Iss-assets/meteor_speed1.gif")

        if (meteor.threat_score <= 30) {
            bgImg = require("../Iss-assets/meteor_bg1.png")
            size = 100
        } else if (meteor.threat_score <= 75) {
            bgImg = require("../Iss-assets/meteor_bg2.png")
            size = 150

        } else {
            bgImg = require("../Iss-assets/meteor_bg3.png")
            size = 200
        }
                    ...
                    <View style={styles.gifContainer}>
                        ...
                        <View>
                            ...
                            <Text style={styles.cardText}>
                                Diâmetro mínimo - {item.estimated_diameter.kilometers.estimated_diameter_min}
                            </Text>
                            <Text style={styles.cardText}>
                                Diâmetro máximo - {item.estimated_diameter.kilometers.estimated_diameter_max}
                            </Text>
                            <Text style={styles.cardText}>
                                Velocidade - {item.close_approach_data[0].relative_velocity.kilometers_per_hour}
                            </Text>
                            <Text style={styles.cardText}>
                                Distância da Terra - {item.close_approach_data[0].miss_distance.kilometers}
                            </Text>
                        </View>
                    </View>
